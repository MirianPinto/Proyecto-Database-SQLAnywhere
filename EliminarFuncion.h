...
namespace Proyecto_TDatabase {
	...
	/// <summary>
	/// Resumen de EliminarFuncion
	/// </summary>
	public ref class EliminarFuncion : public System::Windows::Forms::Form
	{
	public:
	...
	public:
		...
		EliminarFuncion(Form^ opciones, String^ users, String^ pass)
		{
			user = users;
			pas = pass;
			Opciones = opciones;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &EliminarFuncion::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &EliminarFuncion::button2_Click);
			// 
			// domainUpDown1
			// 
			...
			this->dataGridView1->Location = System::Drawing::Point(263, 29);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(29, 31);
			...
			this->Name = L"EliminarFuncion";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"EliminarFuncion";
...
#pragma endregion
		...
		void Eliminarfuncion(String^ codigoELiminar)
		{
			String^ connString = "Dsn=TBD1;uid=" + user + ";pwd=" + pas;
			OdbcConnection^ CON = gcnew OdbcConnection(connString);
			try
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ codigoELiminar1 = "DROP FUNCTION " + domainUpDown1->Text + "; ";

		Eliminarfuncion(codigoELiminar1);
