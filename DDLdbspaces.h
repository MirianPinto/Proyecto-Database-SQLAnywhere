...
namespace Proyecto_TDatabase {
	...
	/// <summary>
	/// Resumen de DDLdbspaces
	/// </summary>
	public ref class DDLdbspaces : public System::Windows::Forms::Form
	{
	public:
		DDLdbspaces(void)
		{
	...
	public:
		...
		DDLdbspaces(Form^ opciones, String^ a, String^ b)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Click += gcnew System::EventHandler(this, &DDLdbspaces::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DDLdbspaces::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DDLdbspaces::button2_Click);
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(245, 16);
			this->label1->TabIndex = 43;
			this->label1->Text = L"Elija el DDL del dbspace que quiere ver";
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &DDLdbspaces::button1_Click);
			// 
			// DDLdbspaces
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(527, 399);
			...
			this->Name = L"DDLdbspaces";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"DDLdbspaces";
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	Sentencia->Text = "CREATE DBSPACE nombre_dbspace AS nombre_dbspace.db;\r\n";
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	Sentencia->Text = "DROP DBSPACE nombre_dbspace;\r\n";
