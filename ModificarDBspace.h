...
namespace Proyecto_TDatabase {
	...
	/// </summary>
	public ref class ModificarDBspace : public System::Windows::Forms::Form
	{
	public:
		ModificarDBspace(void)
		{
			InitializeComponent();
			//
		...
		String^ acces;
		ModificarDBspace(Form^ opciones, String^ users, String^ pass)
		{
			user = users;
			pas = pass;
			Opciones = opciones;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &ModificarDBspace::button1_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(238, 414);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(89, 39);
			this->button2->TabIndex = 1;
			this->button2->Text = L"Alterar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &ModificarDBspace::button2_Click);
			// 
			// domainUpDown1
			// 
			...
			this->domainUpDown1->SelectedItemChanged += gcnew System::EventHandler(this, &ModificarDBspace::domainUpDown1_SelectedItemChanged);
			// 
			// dataGridView1
			// 
			...
			this->label1->Location = System::Drawing::Point(204, 107);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(151, 20);
			this->label1->TabIndex = 4;
			this->label1->Text = L"DBspace a alterar:";
			// 
			// Alterar
			// 
...
#pragma endregion
		...
		void sbspace2()
		{
			String^ codigo = "CREATE DBSPACE " + domainUpDown1->Text + " RENAME C:\\SQLANYWHERE\\DBspace\\" + domainUpDown1->Text + ".db\'\;";
			Alterar->Text = codigo;
		...
		void Modificarsbspace(String^ codigoELiminar)
		{
			String^ connString = "Dsn=TBD1;uid=" + user + ";pwd=" + pas;
			OdbcConnection^ CON = gcnew OdbcConnection(connString);
			try
